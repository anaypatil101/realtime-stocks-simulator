      ...
      <div className="container px-8 sm:px-16 py-4 mx-auto">
        <div className="lg:flex">
          <div className="w-full -mx-6 lg:w-2/5">
            <div className="px-6">
              <div>
                <Link to="/" className="text-xl font-bold text-gray-800 dark:text-white hover:text-gray-700 dark:hover:text-gray-300">Realtime Stock Simulator</Link>
              </div>

              <p className="max-w-md mt-2 text-gray-500 dark:text-gray-400">The trading platform for all.</p>

              <div className="flex mt-4 -mx-2">
                <a href="https://github.com/anaypatil101" className="mx-2 text-gray-700 dark:text-gray-200 hover:text-gray-600 dark:hover:text-gray-400" aria-label="GitHub" target="_blank" rel="noopener noreferrer">
                ...
                <a href="https://github.com/anaypatil101" className="mx-2 text-gray-700 dark:text-gray-200 hover:text-gray-600 dark:hover:text-gray-400" aria-label="Personal Website" target="_blank" rel="noopener noreferrer">
                  <svg className="text-gray-800 dark:text-white h-4 w-4" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
          ...
          <div className="mt-6 lg:mt-0 lg:flex-1">
            <div className="grid grid-cols-2 gap-6 sm:grid-cols-4">
              ...
              <div>
                ...
                <a href="https://github.com/anaypatil101" className="block mt-2 text-sm text-gray-600 dark:text-gray-400 hover:underline" target="_blank" rel="noopener noreferrer">GitHub</a>
                <a href="" className="block mt-2 text-sm text-gray-600 dark:text-gray-400 hover:underline" target="_blank" rel="noopener noreferrer">Personal Site (Under Maintainence)</a>
              </div>
            </div>
          </div>
        </div>
        ...
        <div>
          <p className="text-center text-gray-800 dark:text-white">© Realtime Stock Simulator {new Date().getFullYear()}</p>
        </div>
      </div>
    </footer>
  );
