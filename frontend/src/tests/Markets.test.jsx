...
test('if not logged in, login/regster button is shown on the top right', () => {
  ...
  expect(
    screen.getByText(
      /see our selection of the biggest names in the industry\. currently 0 stocks available for purchase\./i,
    ),
  ).toHaveTextContent('Currently 0 stocks available for purchase.');
});
